...
- (void)registerMovistDefaults
{
	...
	[dict setObject:[NSArchiver archivedDataWithRootObject:textColor] forKey:MSubtitleTextColorKey];
	[dict setObject:[NSArchiver archivedDataWithRootObject:strokeColor] forKey:MSubtitleStrokeColorKey];
	[dict setObject:[NSNumber numberWithFloat:4.0] forKey:MSubtitleStrokeWidthKey];
	[dict setObject:[NSArchiver archivedDataWithRootObject:shadowColor] forKey:MSubtitleShadowColorKey];
